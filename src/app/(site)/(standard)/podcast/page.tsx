          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-4">
              <a
                ...
                className="group/yt flex items-center gap-2 sm:gap-3 bg-[#FF0000] hover:bg-[#CC0000] text-white px-4 sm:px-8 py-3 sm:py-5 font-bold text-xs sm:text-sm uppercase tracking-wider transition-all duration-300 hover:shadow-2xl hover:shadow-[#FF0000]/30 hover:-translate-y-1"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group/sp flex items-center gap-2 sm:gap-3 bg-[#1DB954] hover:bg-[#1ed760] text-white px-4 sm:px-8 py-3 sm:py-5 font-bold text-xs sm:text-sm uppercase tracking-wider transition-all duration-300 hover:shadow-2xl hover:shadow-[#1DB954]/30 hover:-translate-y-1"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
