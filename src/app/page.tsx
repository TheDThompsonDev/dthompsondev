          ...
          <header className="px-6 md:px-16 py-6 md:py-8">
            <div className="flex items-center justify-between gap-8">
              ...
              <nav className="hidden lg:flex items-center gap-8">
                ...
                <Link href="/podcast" className="text-[#153230]/70 hover:text-[#153230] font-semibold transition-colors">
                  Podcast
                </Link>
        ...
        <section className="relative z-[50] bg-white rounded-[32px] mx-4 mt-6 px-6 md:px-12 py-16 md:py-20 shadow-lg border border-[#E2F3F2]">
          <ScrollReveal>
            ...
            <p className="text-lg md:text-xl text-[#153230]/70 mb-16 max-w-3xl leading-relaxed">
              Building bridges between developers and opportunities through authentic engagement, technical excellence, and unwavering commitment to community success. As a community builder and personality, I scale communities that create lasting impact.
            </p>
          </ScrollReveal>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="bg-gradient-to-r from-[#84803E] to-[#6a6731] text-white p-4">
                    <h4 className="font-bold text-lg">Dallas Software Developers Group</h4>
                    <p className="text-sm opacity-90">Weekly meetups bringing together 12,000+ developers</p>
                  </div>
                </div>
                <div className="rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                  <img 
                  ...
                  <div className="bg-gradient-to-r from-[#4D7DA3] to-[#3d6a8a] text-white p-4">
                    <h4 className="font-bold text-lg">Commit Your Code Conference</h4>
                    <p className="text-sm opacity-90">2-day technical conference with 8,960+ total attendees</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-br from-[#4D7DA3]/5 to-[#4D7DA3]/10 rounded-3xl p-8 md:p-10 border border-[#4D7DA3]/20">
                <div className="flex flex-col md:flex-row items-start gap-6 mb-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl md:text-4xl font-black text-[#153230] mb-3">The Commit Your Code Conference 2025</h3>
                    <p className="text-lg md:text-xl text-[#4D7DA3] font-bold mb-4">2-Day Conference • 60 Speakers • 3 Technical Tracks • 100% Charity • Global Reach</p>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                      <div className="text-center bg-white/60 rounded-xl p-4">
                        <div className="text-2xl md:text-3xl font-black text-[#4D7DA3]">8,960</div>
                        <div className="text-sm text-[#153230]/70 font-bold">Total Attendees</div>
                      </div>
                      <div className="text-center bg-white/60 rounded-xl p-4">
                        <div className="text-2xl md:text-3xl font-black text-[#4D7DA3]">860</div>
                        <div className="text-sm text-[#153230]/70 font-bold">In-Person</div>
                      </div>
                      <div className="text-center bg-white/60 rounded-xl p-4">
                        <div className="text-2xl md:text-3xl font-black text-[#4D7DA3]">8,100</div>
                        <div className="text-sm text-[#153230]/70 font-bold">Online</div>
                      </div>
                      <div className="text-center bg-white/60 rounded-xl p-4">
                        <div className="text-2xl md:text-3xl font-black text-[#4D7DA3]">300%</div>
                        <div className="text-sm text-[#153230]/70 font-bold">Growth</div>
                      </div>
                    </div>
                  </div>
                </div>
                <p className="text-lg md:text-xl text-[#153230]/80 leading-relaxed mb-6">
                  Founded and organized Dallas's premier technical conference with <strong>8,960+ total attendees</strong> (860 in-person, 8,100 online) representing <strong>300% growth</strong> from CYC24. The event <strong>trended globally on social media</strong> with people still making CYC posts 3 weeks post-conference. <strong>37% of attendees work in tech but had never attended a tech conference</strong>, demonstrating our ability to reach new audiences and create accessible learning opportunities.
                </p>
                
                <div className="bg-white/40 rounded-2xl p-6 mb-6">
                  <h4 className="text-lg font-black text-[#153230] mb-4">Past Sponsors & Speakers</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm font-bold text-[#4D7DA3] mb-2">SPONSORS</p>
                      <p className="text-sm text-[#153230]/80">Agora, Vonage, GitHub, Grafana Labs, TuxCare, Yum! Brands, Appwrite, and more</p>
                    </div>
                    <div>
                      <p className="text-sm font-bold text-[#4D7DA3] mb-2">SPEAKERS</p>
                      <p className="text-sm text-[#153230]/80">Google, Microsoft, Digital Ocean, Neo4j, Spotify, and more</p>
                    </div>
                  </div>
                </div>
                
                <div className="flex flex-wrap gap-3">
                  <span className="bg-[#4D7DA3] text-white px-4 py-2 rounded-full text-sm font-bold">Global Conference Organizer</span>
                  <span className="bg-[#4D7DA3] text-white px-4 py-2 rounded-full text-sm font-bold">300% Growth</span>
                  <span className="bg-[#4D7DA3] text-white px-4 py-2 rounded-full text-sm font-bold">Social Media Trending</span>
                  <span className="bg-[#4D7DA3] text-white px-4 py-2 rounded-full text-sm font-bold">Accessible Education</span>
                </div>
              </div>
            </ScrollReveal>
              ...
              <div className="my-16">
                <div className="rounded-3xl overflow-hidden shadow-2xl">
                  ...
                  <div className="bg-gradient-to-r from-[#4D7DA3] to-[#3d6a8a] text-white p-6 md:p-8">
                    <h4 className="text-2xl md:text-3xl font-black mb-2">Commit Your Code Conference 2025</h4>
                    <p className="text-lg opacity-90">8,960+ attendees • 300% growth • Global social media trending • 37% first-time conference attendees</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300}>
              <div className="bg-gradient-to-br from-[#84803E]/5 to-[#84803E]/10 rounded-3xl p-8 md:p-10 border border-[#84803E]/20">
                <div className="flex flex-col md:flex-row items-start gap-6 mb-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl md:text-4xl font-black text-[#153230] mb-3">Dallas Software Developers Group</h3>
                    <p className="text-lg md:text-xl text-[#84803E] font-bold mb-4">12,000+ Active Members • Weekly Meetups • Discord Community</p>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                      <div className="text-center bg-white/60 rounded-xl p-4">
                        <div className="text-2xl md:text-3xl font-black text-[#84803E]">12K+</div>
                        <div className="text-sm text-[#153230]/70 font-bold">Members</div>
                      </div>
                      <div className="text-center bg-white/60 rounded-xl p-4">
                        <div className="text-2xl md:text-3xl font-black text-[#84803E]">200+</div>
                        <div className="text-sm text-[#153230]/70 font-bold">Meetups</div>
                      </div>
                      <div className="text-center bg-white/60 rounded-xl p-4">
                        <div className="text-2xl md:text-3xl font-black text-[#84803E]">500+</div>
                        <div className="text-sm text-[#153230]/70 font-bold">Placements</div>
                      </div>
                      <div className="text-center bg-white/60 rounded-xl p-4">
                        <div className="text-2xl md:text-3xl font-black text-[#84803E]">5+</div>
                ...
                <p className="text-lg md:text-xl text-[#153230]/80 leading-relaxed mb-6">
                  Built and scaled one of the most active developer communities globally from the ground up. Through weekly meetups, technical workshops, and strategic networking events, I've created a thriving ecosystem that directly contributes to career growth and job placements across the Dallas tech scene.
                </p>
                <div className="flex flex-wrap gap-3">
                  <span className="bg-[#84803E] text-white px-4 py-2 rounded-full text-sm font-bold">Community Builder</span>
                  <span className="bg-[#84803E] text-white px-4 py-2 rounded-full text-sm font-bold">Discord Management</span>
                  <span className="bg-[#84803E] text-white px-4 py-2 rounded-full text-sm font-bold">Event Organization</span>
                  <span className="bg-[#84803E] text-white px-4 py-2 rounded-full text-sm font-bold">Career Development</span>
                </div>
              </div>
            </ScrollReveal>
              ...
              <div className="my-16">
                <div className="rounded-3xl overflow-hidden shadow-2xl">
                  ...
                  <div className="bg-gradient-to-r from-[#84803E] to-[#6a6731] text-white p-6 md:p-8">
                    <h4 className="text-2xl md:text-3xl font-black mb-2">Dallas Software Developers Group</h4>
                    <p className="text-lg opacity-90">12,000+ members • Weekly meetups • 200+ events • 500+ career placements</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={400}>
              <div className="bg-gradient-to-br from-[#153230]/5 to-[#153230]/10 rounded-3xl p-8 md:p-10 border border-[#153230]/20">
                <div className="flex flex-col md:flex-row items-start gap-6 mb-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl md:text-4xl font-black text-[#153230] mb-3">Community Scaling Expertise</h3>
                    <p className="text-lg md:text-xl text-[#153230] font-bold mb-4">Proven Ability to Build & Scale Developer Communities</p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                      <div className="text-center bg-white/60 rounded-xl p-6">
                        <div className="text-3xl font-black text-[#153230] mb-2">Strategy</div>
                        <div className="text-sm text-[#153230]/70">Community architecture, engagement frameworks, and growth strategies that scale</div>
                      </div>
                      <div className="text-center bg-white/60 rounded-xl p-6">
                        <div className="text-3xl font-black text-[#153230] mb-2">Execution</div>
                        <div className="text-sm text-[#153230]/70">Event management, content creation, and member retention at scale</div>
                      </div>
                      <div className="text-center bg-white/60 rounded-xl p-6">
                        <div className="text-3xl font-black text-[#153230] mb-2">Impact</div>
                        <div className="text-sm text-[#153230]/70">Measurable outcomes in career development and community value</div>
                      </div>
                    </div>
                  </div>
                </div>
                <p className="text-lg md:text-xl text-[#153230]/80 leading-relaxed mb-6">
                  As a community builder and personality, I specialize in creating scalable developer communities that deliver real value. My approach combines authentic engagement, strategic content creation, and systematic growth methodologies that can be replicated across different markets and organizations.
                </p>
                <div className="flex flex-wrap gap-3">
                  <span className="bg-[#153230] text-white px-4 py-2 rounded-full text-sm font-bold">Community Strategy</span>
                  <span className="bg-[#153230] text-white px-4 py-2 rounded-full text-sm font-bold">Growth Hacking</span>
                  <span className="bg-[#153230] text-white px-4 py-2 rounded-full text-sm font-bold">Brand Building</span>
                  <span className="bg-[#153230] text-white px-4 py-2 rounded-full text-sm font-bold">Scalable Systems</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
