    ...
    <div className="min-h-screen bg-[#E2F3F2]">
      <div className="max-w-[1400px] mx-auto">
        <div className="bg-white rounded-[32px] shadow-xl m-4 overflow-hidden border border-[#4D7DA3]/10">
          ...
          <section className="px-8 md:px-16 py-12 md:py-16">
            <ScrollReveal>
              <div className="text-center max-w-4xl mx-auto">
                <div className="inline-flex items-center gap-2.5 bg-[#4D7DA3] text-white px-4 py-2 rounded-full shadow-lg mb-8">
                  ...
                  <span className="text-sm font-bold tracking-wide">LIVE PODCAST</span>
                </div>

                <h1 className="text-4xl md:text-6xl font-black text-[#153230] mb-6 leading-tight">
                  The Programming<br />
                  <span className="text-[#4D7DA3]">Podcast</span>
                </h1>
                
                <p className="text-xl text-[#153230]/70 mb-8 leading-relaxed max-w-3xl mx-auto">
                  Join Leon Noel and I as we dive deep into programming, technology, and career growth. 
                  From the latest in AI to practical career advice, we cover everything developers need to know.
                </p>
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-12">
                  <a 
                    ...
                    className="bg-[#FF0000] text-white px-8 py-4 rounded-full hover:bg-[#CC0000] hover:scale-105 transition-all duration-300 font-bold text-lg flex items-center gap-3"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-[#1DB954] text-white px-8 py-4 rounded-full hover:bg-[#1ed760] hover:scale-105 transition-all duration-300 font-bold text-lg flex items-center gap-3"
                  >
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-[#153230] text-white px-8 py-4 rounded-full hover:bg-[#4D7DA3] hover:scale-105 transition-all duration-300 font-bold text-lg flex items-center gap-3"
                  >
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Episodes Section with Filtering */}
