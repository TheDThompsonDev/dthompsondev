...
import { RadioTunerDesktopProps } from './types';
    ...
    return (
        ...
        `,
            ...
            {[...Array(4)].map((_, i) => (
                <div
                    key={i}
                    className={`absolute w-3 h-3 rounded-full bg-gradient-to-br from-[#e8e8e8] to-[#a0a0a0] border border-[#707070] shadow-md ${i === 0 ? 'top-4 left-4' : i === 1 ? 'top-4 right-4' : i === 2 ? 'bottom-4 left-4' : 'bottom-4 right-4'
                        }`}
                    style={{
