      ...
      <div className="p-6 md:p-8 lg:p-10">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="shrink-0 relative">
            ...
            {index !== undefined && (
              <div className="absolute -top-3 -left-3 w-12 h-12 bg-[#2e6089] text-white flex items-center justify-center font-black text-sm border-4 border-white shadow-lg">
                #{index + 1}
              </div>
            )}
          </div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              {isMultiPlatform && (
                <>
                  <span className="text-[#153230]/30">•</span>
                  <span className="text-xs font-bold text-[#153230] uppercase tracking-wider bg-[#4D7DA3]/20 px-2 py-1">
                    Multi-Platform
                  </span>
                </>
              )}
            ...
            <div className="flex flex-wrap gap-4 mt-auto">
              ...
              {(episode.platform === 'spotify' || episode.audioUrl) && (
                <a
                  ...
                  className="group/spotify flex items-center gap-3 bg-[#15803d] hover:bg-[#16a34a] text-white px-6 py-4 font-bold text-sm uppercase tracking-wider transition-all duration-300 hover:shadow-2xl hover:shadow-[#15803d]/30 hover:-translate-y-1"
                >
              ...
              {(episode.platform === 'youtube' || episode.videoUrl) && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group/youtube flex items-center gap-3 bg-[#CC0000] hover:bg-[#990000] text-white px-6 py-4 font-bold text-sm uppercase tracking-wider transition-all duration-300 hover:shadow-2xl hover:shadow-[#CC0000]/30 hover:-translate-y-1"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
