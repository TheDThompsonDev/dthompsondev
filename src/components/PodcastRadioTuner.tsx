...
export function PodcastRadioTuner({ episodes }: PodcastRadioTunerProps) {
  ...
  return (
    <>
      {/* Mobile View - Compact Vintage Radio Style */}
      <div className="lg:hidden">
        ...
        >
          ...
          {[...Array(4)].map((_, i) => (
            <div
              key={i}
              className={`absolute w-2.5 h-2.5 rounded-full bg-linear-to-br from-[#e8e8e8] to-[#a0a0a0] border border-[#707070] shadow-md z-10 ${
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-3 mt-3">
              {/* PREV Knob */}
              <button
                onClick={() => setSelectedIndex((prev) => (prev - 1 + mergedEpisodes.length) % mergedEpisodes.length)}
              ...
              {/* NEXT Knob */}
              <button
                onClick={() => setSelectedIndex((prev) => (prev + 1) % mergedEpisodes.length)}
                className="flex-1 relative"
              >
                <div className="text-[7px] text-center text-[#c9a961] font-bold uppercase tracking-wider mb-1 opacity-70">
                  Next
      ...
      {/* Desktop View - Vintage Radio */}
      <div 
        className="hidden lg:block relative bg-linear-to-b from-[#1a4039] via-[#153230] to-[#0f2624] rounded-2xl p-3 md:p-4 border-6 border-[#0a1a18] shadow-2xl overflow-hidden"
            ...
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <div className="shrink-0">
                ...
                <div className="relative w-14 h-14 md:w-16 md:h-16">
                  <div className="w-full h-full rounded-full bg-linear-to-b from-[#5c3d2e] to-[#3d2817] border-4 border-[#2a1810] shadow-2xl relative"
                    style={{
              ...
              <div className="shrink-0">
                ...
                <div className="relative w-14 h-14 md:w-16 md:h-16">
                  <div 
                    className="w-full h-full rounded-full bg-linear-to-b from-[#5c3d2e] to-[#3d2817] border-4 border-[#2a1810] shadow-2xl relative cursor-pointer hover:from-[#6a4838] hover:to-[#4a3020] transition-all"
                ...
                <div className="relative h-fit">
                  <div className="bg-[#0a1a18] p-2 rounded-lg border-2 border-[#4D7DA3] shadow-xl relative" style={{
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 flex gap-2">
                      {selectedEpisode.audioUrl && (
                        <div className="relative">
                          <div className="w-8 h-8 bg-linear-to-b from-[#1DB954] to-[#127a3a] rounded-full flex items-center justify-center shadow-xl border-2 border-[#5c3d2e] animate-pulse" style={{
                      ...
                      {selectedEpisode.videoUrl && (
                        <div className="relative">
                          <div className="w-8 h-8 bg-linear-to-b from-[#FF0000] to-[#b30000] rounded-full flex items-center justify-center shadow-xl border-2 border-[#5c3d2e] animate-pulse" style={{
                  ...
                  <div className="flex gap-2">
                    {selectedEpisode.audioUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group/sp relative flex items-center gap-1.5 bg-linear-to-b from-[#1ed760] to-[#1DB954] hover:from-[#1DB954] hover:to-[#158c3e] text-white px-3 py-2 font-black text-[10px] uppercase tracking-wider transition-all duration-300 shadow-lg border-2 border-[#127a3a] hover:-translate-y-0.5 overflow-hidden"
                        style={{
                    ...
                    {selectedEpisode.videoUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group/yt relative flex items-center gap-1.5 bg-linear-to-b from-[#ff3333] to-[#FF0000] hover:from-[#FF0000] hover:to-[#cc0000] text-white px-3 py-2 font-black text-[10px] uppercase tracking-wider transition-all duration-300 shadow-lg border-2 border-[#b30000] hover:-translate-y-0.5 overflow-hidden"
                        style={{
              ...
              <div className="absolute inset-0 flex items-center justify-center gap-2 md:gap-3 px-8">
                {[...Array(12)].map((_, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="w-1 md:w-1.5 bg-linear-to-t from-[#4D7DA3] to-[#84803E] rounded-full opacity-40"
                      style={{
